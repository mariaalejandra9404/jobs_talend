...
public class Mock_job_for_Guess_schema implements TalendJob {
	...
	public void tLibraryLoad_4_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tLibraryLoad_5_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tLibraryLoad_4_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tLibraryLoad_5_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tLibraryLoad_4Process(
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String url = "jdbc:oracle:thin:@10.20.0.251:1521:UD";
				java.sql.Connection conn = java.sql.DriverManager
						.getConnection(url, "DWHSICTITAN", "DWHSICTITAN");
				...
				java.sql.ResultSet rs = stm
						.executeQuery("select com.vigencia||'',     com.numero_documento,     prd.numero_disponibilidad,    prd.numero_registro  from pr.pr_compromisos com, pr.pr_registro_disponibilidad prd where com.vigencia = extract(year from sysdate)  and com.codigo_unidad_ejecutora = '01' and com.numero_documento = 51818702 and com.vigencia = prd.vigencia and com.codigo_unidad_ejecutora = prd.codigo_unidad_ejecutora and com.numero_registro = prd.numero_registro");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File(
						"/home/mariaalejandra9404/Documentos/Programas/Talend/TOS_DI-20160704_1411-V6.2.1/temp/TempGuessSchemaDelimitedFile.csv"))
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class
					.getClassLoader().getResourceAsStream(
							"local_project/mock_job_for_guess_schema_0_1/contexts/"
...
/************************************************************************************************
 * 37319 characters generated by Talend Open Studio for Data Integration on the
 * 8 de mayo de 2019 07:49:39 PM GMT
 ************************************************************************************************/
