		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_Expression_builder_RowGenerator2.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_Expression_builder_RowGenerator2.length == 0) {
				...
				dis.readFully(
						commonByteArray_LOCAL_PROJECT_Expression_builder_RowGenerator2,
						0, length);
		...
		try {
			...
			java.io.InputStream inContext = Expression_builder_RowGenerator2.class
					.getClassLoader().getResourceAsStream(
							"local_project/expression_builder_rowgenerator2/contexts/"
...
/************************************************************************************************
 * 25802 characters generated by Talend Open Studio for Data Integration on the
 * 8 de mayo de 2019 07:07:43 PM GMT
 ************************************************************************************************/
